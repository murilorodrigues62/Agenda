...
public class ContatoDAO {
    ...
    public  List<Contato>  buscaContato(String nome)
    {
        ...
        Cursor cursor = database.query(SQLiteHelper.DATABASE_TABLE, new String[]
                          { SQLiteHelper.KEY_ID,
                            SQLiteHelper.KEY_NAME,
                            SQLiteHelper.KEY_FONE,
                            SQLiteHelper.KEY_EMAIL},

                          SQLiteHelper.KEY_NAME  + " like ? or " +
                          SQLiteHelper.KEY_FONE  + " like ? or " +
                          SQLiteHelper.KEY_EMAIL + " like ? ",
    ...
    public void updateContact(Contato c) {
        ...
        updateValues.put(SQLiteHelper.KEY_NIVER, c.getNiver());
    ...
    public void createContact( Contato c) {
        ...
        values.put(SQLiteHelper.KEY_NIVER, c.getNiver());
